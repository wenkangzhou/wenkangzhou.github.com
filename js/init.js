...
// Ready stuff
	...
	function myJs() {
		...
		$(".container p img").hover(function() {
				...
				$(".container p img").removeClass("showbox").removeClass("fadeout");
			}
		);

		$(".box").hover(function() {
				$(this).find(".box-info-download").show(500);
				$(this).find(".box-info-fork").show(500);
			},function(){	
				$(this).find(".box-info-download").hide();
